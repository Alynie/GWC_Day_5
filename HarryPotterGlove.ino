/*For the sound glove, this code plays the Harry Potter Theme
 * when the glove is closed and no sound when the glove is open
 */
...
if (bendSensorReading < 150 || bendSensorReading > 350) {delay(500);}
else if (150 < bendSensorReading < 350)
{
